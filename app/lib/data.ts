...
export const THEMES: ThemeData[] = [
  ...
  },
  {
    name: '미국나스닥',
    k: {
      ticker: 'KODEX 미국나스닥100TR',
      code: '379800',
      price: 18240,
      change: 0.72,
      nav: 18220,
      aum: '12,850억',
      aumRaw: 1285000000000,
      vol: '55만주',
      expense: 0.05,
      discount: 0.11,
...
export const ALERTS: AlertItem[] = [
  {
    ...
    type: 'discount',
    theme: '반도체',
    message: 'TIGER 반도체 괴리율 -0.29% — 임계치 초과',
    time: '09:32',
    severity: 'warning',
  },
  {
    ...
    type: 'aum',
    theme: '2차전지',
    message: 'KODEX 2차전지 AUM 전일 대비 -8.2% 급감',
    time: '10:15',
    severity: 'danger',
  },
  {
    ...
    type: 'performance',
    theme: '미국나스닥',
    message: 'KODEX 나스닥100TR 1개월 수익률 TIGER 대비 +0.34%p 우위',
    time: '11:00',
    severity: 'info',
  },
  {
    ...
    type: 'new',
    theme: '전체',
    message: 'TIGER 글로벌AI&반도체 신규 상장 감지 (12/2)',
    time: '어제',
    severity: 'info',
  },
];
